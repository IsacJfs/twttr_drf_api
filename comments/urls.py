...
from .views import (
    ...
    DetalheComentarioView,
    CurtirComentarioView,
)
...
urlpatterns = [
    ...
    path(
        "comentarios/listar/",
        ListarComentariosView.as_view(),
        name="listar-comentarios",
    ),
    path(
        "comentarios/<int:pk>/",
        DetalheComentarioView.as_view(),
        name="detalhe-comentario",
    ),
    path(
        "comentarios/<int:pk>/curtir/",
        CurtirComentarioView.as_view(),
